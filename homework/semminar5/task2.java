...
public class task2 {
	public static void main(String[] args) {
		...
		TreeMap<NamePopularity, String> sortedNameFrequency = new TreeMap<>(Comparator
				.comparing(NamePopularity::getCount, Comparator.reverseOrder()).thenComparing(NamePopularity::getName));
